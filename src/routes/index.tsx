...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Marmoraria Premium | Granito, Mármore e Quartzo Sob Medida — PedraNobre" },
      { name: "description", content: "Bancadas, pias e pisos em granito São Gabriel, mármore branco Carrara e quartzo. Preço justo, instalação profissional e entrega em todo o Brasil. Solicite seu orçamento." },
      ...
      { property: "og:image", content: heroGranite },
      { name: "twitter:image", content: heroGranite },
    ],
    scripts: [
      {
