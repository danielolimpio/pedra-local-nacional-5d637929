...
const POSTS: Record<string, Post> = {
  ...
  "pedra-para-escada-granito-marmore-travertino": {
    ...
    body: [
      ...
      { p: "O mármore continua sendo a pedra mais desejada para escadas de alto padrão. Branco Carrara, Calacatta Gold e Travertino Romano são presença certa em projetos publicados em revistas de arquitetura como a Casa Vogue e em portais como o ArchDaily Brasil. O motivo é simples: nenhuma outra pedra tem veio tão expressivo, tão único e tão luxuoso." },
